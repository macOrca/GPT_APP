...
def analyze_submission(problem_description, sample_code, input_example, output_example, code, execution_result, user_profile):
    ...
    上記の内容に基づいて、以下の指示に従ってください。高校生にもわかるように、専門用語を使わず、平易で要点を絞った表現にしてください。まず、問題の理解、アルゴリズム設計、コード実装、実行結果の4点について、ユーザの理解状態を推測してください。次に、ユーザの誤った理解の内容を示し、原因を推測してください。加えて、解答について、「正解」、「不正解」のどちらかのみを回答してください。最後に、提出コードの良い点と誤った点をフィードバックしてください。回答にあたっては学習者の理解状態を考慮し、誤った点については場所を明示し、直接の回答を示さず、ユーザが正しい回答にたどり着くためのヒントのみを示してください。
